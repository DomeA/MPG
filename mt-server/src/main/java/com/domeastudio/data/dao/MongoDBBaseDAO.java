package com.domeastudio.data.dao;
...
public class MongoDBBaseDAO<T extends Serializable> {
    private static Logger logger = Logger.getLogger(MongoDBBaseDAO.class);
    ...
    public void saveFile(File file, String fileUrl) {
        try {
            ...
            logger.trace("MongoDBBaseDAO<" + getEntityClass().getSimpleName() + ">.saveFile:", e);
            e.printStackTrace();
        }
    }
    ...
    public GridFSDBFile retrieveFileOne(String filename) {
        try {
            ...
            logger.trace("MongoDBBaseDAO<" + getEntityClass().getSimpleName() + ">.retrieveFileOne:", e);
            e.printStackTrace();
        }
        return null;
    }
    ...
    private Query buildBaseQuery(T t) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                logger.trace("MongoDBBaseDAO<" + getEntityClass().getSimpleName() + ">.buildBaseQuery:", e);
                e.printStackTrace();
    ...
    private Update buildBaseUpdate(T t) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                logger.trace("MongoDBBaseDAO<" + getEntityClass().getSimpleName() + ">.buildBaseUpdate:", e);
                e.printStackTrace();
            }
        }
        return update;
